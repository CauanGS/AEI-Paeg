  ...
  if (error || !project) {
    return (
      <div className="text-center p-10 bg-white min-h-[calc(100vh-85px)]">
        <h1 className="text-red-500 text-xl font-bold mb-2">Projeto não encontrado</h1>
        <p className="text-gray-600">O projeto que você procura pode ter sido removido, ter tido seu ID alterado ou <br /> estar temporariamente indisponível. Pedimos desculpas pelo inconveniente.</p>
        <Link 
          href="/projects"
