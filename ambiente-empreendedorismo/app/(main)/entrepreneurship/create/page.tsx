          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading} 
                className={`w-full cursor-pointer bg-[#2E2B82] text-white px-6 py-3 rounded-md text-lg font-bold hover:bg-[#292570] transition duration-200 ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
