...
export default function CreateNewsPage() {
  ...
  if (!allowed) return <div className="py-20 text-center text-lg text-gray-600 bg-gray-50 min-h-screen"></div>;

  return (
    <div className="bg-gray-50 py-12">
      <div className="container mx-auto max-w-3xl p-6 bg-white shadow-lg rounded-lg">
        <h1 className="text-4xl font-bold text-[#2E2B82] text-center mb-8">Criar Nova Notícia</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label htmlFor="image" className="block text-sm font-medium text-gray-700 mb-1">Imagem da Notícia (Opcional)</label>
            <input
              type="file"
              id="image"
